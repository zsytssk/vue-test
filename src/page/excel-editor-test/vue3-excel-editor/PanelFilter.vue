      ...
      <div class="panel-content">
        <div class="panel-action">
          ...
          <button class="panel-button float-right" @click="sort(-1)">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              class="svg-inline--fa fa-sort-alpha-up-alt fa-w-14"
            >
              <path
                fill="currentColor"
          ...
          <div>
            ...
            <div :class="{ show: showDropdown }" class="panel-dropdown">
              <div
                ...
                @click.prevent="setFilterCondition('')"
              >
        ...
        <div>
          <div ref="panelList" class="panel-list">
            <div
              v-for="(item, k) in filteredSortedUniqueValueList.slice(
                0,
                nFilterCount,
              )"
              :key="k"
          ...
          <div
            v-if="filteredSortedUniqueValueList.length > nFilterCount"
            class="normal-text"
            style="float: right"
          >
