        ...
        switch (this.type) {
          ...
          case 'map':
            if (this.options.constructor.name.endsWith('Function')) {
              ...
              return Object.keys(this.options).find(
                (k) => this.options[k] === text,
              )
          default:
            return text
        }
      ...
      default(val) {
        ...
        switch (this.type) {
          ...
          case 'badge':
            ...
            } else return `<span class='badge'>${val}</span>`
          default:
            return val
        }
      },
  ...
  methods: {
    init() {
      ...
      switch (this.type) {
        ...
        case 'map':
          if (this.options.constructor.name === 'AsyncFunction')
            throw new Error(
              'VueExcelColumn: Map does not support Async Function',
            )
          break
        case 'select':
          break
      ...
      this.$parent.registerColumn({
        ...
        noSorting:
          this.noSorting !== null ? this.noSorting : self.$parent.noSorting,
        ...
        get autocomplete() {
          ...
          return self._autocomplete === null
        ...
        get readonly() {
          ...
          return self._readonly === null
            ? self.$parent.readonly
            : self._readonly
        },
        set readonly(val) {
          self._readonly = val
